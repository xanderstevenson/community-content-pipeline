...
#     docx_file_name = str(os.path.basename(docx_file).rsplit('.', 1)[0])
    new_name_text_file = docx_file.replace('docx','txt')
    with open(new_name_text_file, "w") as txt_file:
        print(MY_TEXT, text_file=txt_file)
